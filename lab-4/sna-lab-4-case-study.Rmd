...
by the work of Alan Daly and colleagues and attempts to replicate the
analyses described in Chapter 9: Network Data and Statistical Models
from Social Network Analysis and Education [@carolan2014]. In this case
study we'll revisit the visual and mathematical descriptions of networks
explored in previous case studies to help uncover, and then empirically
test, generative processes that attempt to explain how school leaders
select peers for collaboration or confidential exchanges.
...
For Learning Lab 4, we move beyond previous "mathematical approaches"
used so far and explore the use of ERGMs as a "statistical approach" to
network analysis. Specifically, we will try to replicate the P\* models
used in Chapter 9 of @carolan2014 in order to test hypotheses about
individual and network characteristics that may explain who school
leaders select for collaboration and confidential exchanges.
...
that your audience consists of state policy makers interested in
district-wide reform efforts and have limited background in SNA and
...
Congratulations - you've completed the Learning Lab 4 case study! To
share your work, click the drop down arrow next to the ball of yarn that
says "Knit" at the top of this markdown file, then select "Knit top
HTML". Assuming your code contains no errors, this will create a web
page in your Files pane that serves as a record of your work.
