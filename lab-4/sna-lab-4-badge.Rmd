...
4.  What were the results of these analyses and were they "statistically significant"? If so, what does mean in a network context?

    -   

5.  If this same study were to use standard statistical models that assume independence among observations, how would this influence the study's results?
