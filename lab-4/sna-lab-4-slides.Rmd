...
### Network Theory
- Recall that in previous labs we focused on ways in which data visualization and measurement can be used to describe properties of egos, groups, and complete networks.  networks being described by creating indicators for their structure (e.g., density, reciprocity, etc.) and the members of networks characterized by their position (e.g., centrality). 
These measures convey the image of a fixed network with attitudes or behaviors passing through it, much like airplanes flying to and from different airports. In reality, unlike airports, networks change, and in some instances quickly. Teachers confer with new colleagues and no longer do so with old ones. Some students seek extra help for the first time, while others quit after receiving that help for some time. 
- 
...
Applications, Models, and Example 

???

- networks being described by creating indicators for their structure (e.g., density, reciprocity, etc.) and the members of networks characterized by their position (e.g., centrality). 
These measures convey the image of a fixed network with attitudes or behaviors passing through it, much like airplanes flying to and from different airports. In reality, unlike airports, networks change, and in some instances quickly. Teachers confer with new colleagues and no longer do so with old ones. Some students seek extra help for the first time, while others quit after receiving that help for some time.
- 
