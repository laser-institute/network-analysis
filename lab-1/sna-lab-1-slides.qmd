...
::: columns
::: {.column width="50%"}
[**Actors**]{.underline}, also called nodes or vertices, can be a range of social entities, like:
...
::: columns
::: {.column width="50%"}
1.  [Personal]{.underline} data based on properties of individual actors (e.g., gender, achievement)

2.  [Relational]{.underline} data based on an actor's direct ties with others (e.g., degree or connectedness)

3.  [Structural]{.underline} data based on the entire network of connections actors ties with others (e.g., centrality)
:::
