...
This presentation provides a brief overview of the four defining characteristics of social network analysis, introduces some basic but essential terminology, and highlights some broad applications of SNA with the context of education.
:::
...
This first section introduces what Carolan describes as the four defining characteristics of social network analysis, name: a unique emphasis on structuralism based on ties among actors, a firm grounding in empirical data, it's use of graphical imagery and a new set of mathematical models and descriptive measures.
:::
...
For example, when studying a topic such as teacher effectiveness, most researchers focus on the attributes of the teacher, the teacher's highest degree, use of technology, or test scores of students, for example. By reducing teachers to a set of attributes, they neglect the relations among teachers and between teachers and students and how these relations condition their effectiveness as a teacher. SNA attemps to account for the web of relations---the social structure---in which actors are embedded and that simultaneously may constrain or provide opportunities for those within this web.
:::
...
::: {.column width="40%"}
![MOOC Network Dataset [@kellogg2015massively]](img/mooc-forum.png){fig-align="left"}
:::
:::
...
The image on the right is from publication by LASER Institute PI Shaun Kellogg and details the processes of constructing an online communication network dataset from discussion forums in a Massively Online Open Course for Educators (MOOC-Ed) called *The* *Digital* *Learning* *Transition in* *K-12* *Schools*.
:::
...
What do you think the lines and shapes represent in this depiction of a classroom of second grade students?
:::

::: {.column width="50%"}
![Sociogram from Who Shall Survive? [@moreno1934shall]](img/moreno-jennings.png){fig-align="left" width="80%"}
:::
:::
...
This image is an early example of a sociogram (i.e. a network graph) from a books published in 1934 grimly titled: **Who Shall Survive: A New Approach to the Problem of Human Interrelations.** It's also an excellent example of the roots SNA has in educational research.
...
::: {.column width="50%"}
**Inferential Models (Test & Predict)**
...
Descriptive measures such as degree, reciprocity, and density are used to describe characteristics of individuals or groups in a network and the network as a whole. We'll explore these measures in Module 2.

SNA also has a wide range of statistical models for working with relational data for hypothesis testing and building predictive models, which we'll explore Module 3.
:::
