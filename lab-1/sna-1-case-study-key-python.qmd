...
One package that we'll be using extensively is {pandas}. Pandas is a powerful and flexible open source data analysis and wrangling tool for Python that is used widely by the data science community.
