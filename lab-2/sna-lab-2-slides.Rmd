...
Take a look at one of the newtwork datasets located [here]() and consider the following:
...
While research on whether reported relations measure actual relations is slim, and participant recall considered suspect, **ways to improve instrument validity** include:   
...
- How might you address these threats? 
- 
