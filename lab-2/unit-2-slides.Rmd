...
.center[<img src="img/nodes-edges.jpeg" height="400px"/>]
...
Recall that the key difference between data we might typically focus on for STEM Education Research and data used for social network analysis is the focus on relationships between individual rather than the individual themselves. Therefore therefore, the methodological issues inherent to the collection and management of social network data are somewhat unique in several different ways.
