...
One important  before collecting data  data collection Where do you set the limits when collecting relational data when, in theory, there are no limits (Barnes, 1979; Knoke & Yang, 2008)? There are three generic approaches to addressing this issue: positional, relational, and event-based.
...
Consider a network you may be interested in researching and consider:
