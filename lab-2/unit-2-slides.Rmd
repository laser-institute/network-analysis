...
Consider a network which you are a part of and think about the following:
...
So how exactly do researchers capture these relations? 

1. Specify the **boundary** of our network . 
...
1. In complete-network studies, you select the set of actors that serves as the study's bounded population. Informed by either positional or event-based approaches to network boundary specification, these studies typically measure a small number of relations between each pair of the network's actors.

The collection of network data —specifically, relational data on a set of actors —is primarily informed by whether you are interested in a complete–or ego–level of analyses. 


.panel[.panel-name[Identify Instrument]
