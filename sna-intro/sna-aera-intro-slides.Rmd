...
1. **Disciplinary Knowledge**: Develop an understanding of some basic social network analysis concepts and applications of SNA in education research.

2. **Technical Skills**: Develop proficiency with R, Posit Cloud, and other tools for reproducible and collaborative data-intensive research.

3. **Social Capital**: Obviously, a course with 200+ participants is limiting, but we hope you'll engage in our Q&A discussions and attend our post-course convening!
]
]
