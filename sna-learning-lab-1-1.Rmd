---
title: 'Attributes, Edge-Lists, & igraphs, Oh My!'
subtitle: 'SNA Learning Lab 1.1'
...
-   **Learning Lab 1: Attributes, Edge-Lists, & igraphs, Oh My!** In our first lab, we prepare for analysis by gaining some context about our data; learning how to wrangle network data structures; and examining network descriptives.

-   **Learning Lab 2: Sociograms & Network Visualization.** For our second lab, we discuss the goals of network visualization and ways to explore data network data visually.

-   **Learning Lab 3: Cores, Cliques, & Communities.** We wrap up SNA Module 1 with quick look at both "bottom-up" and "top-down" approaches to groups within a network. 
