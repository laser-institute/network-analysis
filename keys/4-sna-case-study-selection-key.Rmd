...
**SNA Case Study: School Leader Selection** is once again visit guided
by Alan Daly and colleagues and attempts to replicate the analyses
described in Chapter 9: Network Data and Statistical Models from Social
Network Analysis and Education [@carolan2014]. In this case study we'll
revisit the visual and mathematical descriptions of networks explored in
previous case studies to help uncover, and then empirically test,
generative processes that attempt to explain how school leaders select
peers for collaboration or confidential exchanges.
